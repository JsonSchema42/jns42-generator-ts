...
export class SchemaStrategy extends SchemaStrategyBase<
...
> {
	...
	public isSchemaRootNode(node: unknown): node is Draft04Schema {
	...
	public isSchema(node: unknown): node is Draft04Schema {
